        ...
        this.onMembersAdded(async (context, next) => {
            ...
            for (let cnt = 0; cnt < membersAdded.length; cnt++) {
                if (membersAdded[cnt].id !== context.activity.recipient.id) {
                    await context.sendActivity('Hola, soy un asistente virtual diseñado para responder tus preguntas.');
                }
            }
        ...
        this.onMessage(async (context, next) => {
            if (!process.env.QnAKnowledgebaseId || !process.env.QnAEndpointKey || !process.env.QnAEndpointHostName) {
                ...
                // If no answers were returned from QnA Maker, reply with help.
                    ...
                    await context.sendActivity('Lo siento, no entendí tu pregunta');
                }
